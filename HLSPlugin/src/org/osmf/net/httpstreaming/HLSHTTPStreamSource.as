...
{	
	...
	public class HLSHTTPStreamSource implements IHTTPStreamSource, IHTTPStreamHandler
	{
		 ...
		 * Default constructor.
		 */
		public function HLSHTTPStreamSource(factory:HTTPStreamingFactory, resource:MediaResourceBase, dispatcher:IEventDispatcher)
		{
			if (dispatcher == null)
			{
		...
		public function seek(offset:Number):void
		{
			...
			if(offset > (_indexHandler as HLSIndexHandler).liveEdge)
			{
		...
		protected function doSomeProcessingAndGetBytes():ByteArray
		{
			...
			switch(_state)
			{
				...
				case HTTPStreamingState.END_FRAGMENT:
					...
					var processedEnd:Boolean = false;
					if (_downloader != null)
					{
