...
package org.osmf.events
{
	 ...
	 * 
	 */ 
	public class HLSHTTPStreamingEvent extends Event
	{
		/**
		 ...
		 * Default constructor.
		 */
		public function HLSHTTPStreamingEvent(
			type:String, 
			...
			downloader:HLSHTTPStreamDownloader = null
		)
		{
		 ...
		 */
		public function get downloader():HLSHTTPStreamDownloader
		{
			return _downloader;
		}
		...
		{
			return new HLSHTTPStreamingEvent(
				type, 
				bubbles, 
				cancelable, 
				fragmentDuration, 
		...
		private var _downloader:HLSHTTPStreamDownloader;
	}
}
